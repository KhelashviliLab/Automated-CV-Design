...
The dataset contains six files in total: three zip arhives containing PSF files for the metastable states (protein structure information) and three DCD files (trajectories):
